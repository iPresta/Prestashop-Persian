...
class AdminAddonsCatalogControllerCore extends AdminController
{
	...
	public function initContent()
	{
		...
		$addons_url = 'http://bazaar.presta-shop.ir/iframe/search-1.6.php?psVersion='._PS_VERSION_.'&isoLang='.$iso_lang.'&isoCurrency='.$iso_currency.'&isoCountry='.$iso_country.'&parentUrl='.$parent_domain;
