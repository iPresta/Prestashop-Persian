...
class AdminDashboardControllerCore extends AdminController
{
	...
	public function renderView()
	{
		...
		$this->tpl_view_vars = array(
			...
			'new_version_url' => Tools::getCurrentUrlProtocolPrefix().'api.ipresta.ir/version/check_version.php?v='._PS_VERSION_.'&lang='.$this->context->language->iso_code.'&autoupgrade='.(int)(Module::isInstalled('autoupgrade') && Module::isEnabled('autoupgrade')).'&hosted_mode='.(int)defined('_PS_HOST_MODE_'),
	...
	public function ajaxProcessGetBlogRss()
	{
		...
		if (!$this->isFresh('/config/xml/blog-'.$this->context->language->iso_code.'.xml', 86400))
			if (!$this->refresh('/config/xml/blog-'.$this->context->language->iso_code.'.xml', 'https://api.ipresta.ir/rss/blog/blog-'.$this->context->language->iso_code.'.xml'))
